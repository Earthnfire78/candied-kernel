...
extern struct irq_chip msm_gpio_irq_extn; static inline int gpio_get_value(unsigned gpio) {
...
static inline void msm_tlmm_set_hdrive(enum msm_tlmm_hdrive_tgt tgt,
				       int drv_str) {} static inline void msm_tlmm_set_pull(enum 
msm_tlmm_pull_tgt tgt, int pull) {} static inline int msm_gpio_install_direct_irq(unsigned gpio, 
unsigned irq,
						unsigned int input_polarity) {
	return -ENOSYS;
}
